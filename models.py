...
class Venue(db.Model):
  ...
  # Creating a relationship between the Show and Venue tables.
    shows = db.relationship('Show', backref='venues',lazy='joined', cascade="all, delete")    # Can reference show.venue (as well as venue.shows)
...
class Artist(db.Model):
   ...
   # Creating a relationship between the Show and Artist tables.
    shows = db.relationship('Show', backref='artists', lazy='joined', cascade="all, delete")    # Can reference show.artist (as well as artist.shows)
